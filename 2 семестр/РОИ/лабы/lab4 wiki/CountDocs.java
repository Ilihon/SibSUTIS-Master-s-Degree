...
public class CountDocs {
	...
	public static class IntSumReducer extends Reducer<Text, IntWritable, Text, IntWritable> {// LongWritable, Text> {
		...
		public void cleanup(Context context) throws IOException, InterruptedException {
			context.write(null, new IntWritable(sum)); //new LongWritable(result.get()), null);
		}
	}
